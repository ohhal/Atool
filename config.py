...
log_name = os.path.join(
    os.getcwd(), 'log/flask/log_{}.log'.format(strftime('%Y%m%d')))
...
　　ORM框架就是用于实现ORM技术的程序。
    ...
    # sqlalchemy两个主要配置
    # ORM底层所访问数据库URI
    SQLALCHEMY_DATABASE_URI = 'mysql+pymysql://root:2013224221@47.107.61.65/blog?charset=utf8'
    # 当关闭数据库是否自动提交事务
...
class DevelopmentConfig(Config):
    ...
    # SQLALCHEMY_DATABASE_URI = "mysql://%s:%s@%s/%s" % ('root', '1991', '47.107.61.65', 'flask_blog')
    SQLALCHEMY_DATABASE_URI = 'mysql+pymysql://root:2013224221@47.107.61.65/blog?charset=utf8'
...
class ProductionConfig(Config):
    ...
    """
    #可以通过修改SQLALCHEMY_DATABASE_URI来控制访问不同数据库
    SQLALCHEMY_DATABASE_URI = 'mysql+pymysql://root:2013224221@47.107.61.65/blog'
